// Mirror of the satellite NDVI helpers used by the worker + verification-service.
// We duplicate here so /projects/:id/satellites/refresh can run without a queue
// hop. Keep all three copies in sync until we extract a shared package.
